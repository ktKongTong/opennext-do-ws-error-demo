// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9cd41d3e3db304cf7b3dd3cb1d3546a1)
// Runtime types generated with workerd@1.20250409.0 2025-03-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		DO: DurableObjectNamespace /* DemoDO from opennext-ws-error-do */;
		ASSETS: Fetcher;
	}
}
